# Generated by Django 2.2.16 on 2022-08-09 12:31
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='group',
            name='slug',
            field=models.SlugField(unique=True, verbose_name='Адрес группы в url'),
        ),
        migrations.AlterField(
            model_name='group',
            name='title',
        ...
        migrations.AlterField(
            model_name='post',
            name='pub_date',
            field=models.DateTimeField(auto_now_add=True, verbose_name='Дата пубикации'),
        ),
        migrations.AlterField(
            model_name='post',
            name='text',
